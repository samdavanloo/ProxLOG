...
currentFile = sprintf('./Results/FISTA_CBCD.mat');
tempFile = sprintf('./Results/FISTA_CBCD_temp.mat');
...
crt = 1e-7;
crt_FISTA = 1e-5;
ite_max = 1000; %maximum iteration for whole program
...
for ite = 1:ite_max
    ...
    parfor i = 1:n
        ...
        for j = 1:ite_FISTA
            ...
            [a, p_LOG] = CBCD_LI(G_idx, a_hat, lambda_FISTA, w, crt, ite_RBCD);
