...
currentFile = sprintf('./Results/FISTA_ADMM_TOPIC.mat');
...
ite_ADMM = 500; % iteration for inner ADMM
...
for ite = 1:ite_max
    ...
    parfor i = 1:n
        ...
        for j = 1:ite_FISTA
            ...
            [a, p_LOG, t_parallel(j)] = ADMM_LI(a_hat, G_idx, w, lambda_FISTA, rho, crt, ite_ADMM);
            %             [a, p_LOG] = RBCD_func(G_idx, a_hat, step_size*lambda_FISTA, w, crt, ite_RBCD);
...
save(currentFile, 't_ADMM', 'f', 'A', 'D', 'A_save', 'D_save', 'topic', 'time_real', 'time_CPU', 'grad_prox', 'grad_prox_stepsize', 'grad_D', 'diff_A_D')
